...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "grape", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "glassBottle", "blindfold", "zipties", "silnik", "Wheel", "hull", "fuel"};
    };
    ...
    class med_market {
        ...
        side = "med";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull", "grape", "defibrillator" };
    };
    ...
    class rebel {
        ...
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "grape", "boltcutter", "blastingcharge", "blindfold", "zipties" };
    };
...
class VirtualItems {
	...
	class glassBottle {
        variable = "glassBottle";
        displayName = "STR_Item_glassBottle"; 
        weight = 1;
        buyPrice = 150;
        sellPrice = 75;
        illegal = true;
        edible = -1;
        icon = "icons\glassBottle.paa";
    };
