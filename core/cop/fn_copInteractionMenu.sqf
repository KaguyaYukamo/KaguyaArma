...
switch (playerSide) do {
	case west: {
		...
		if (!(_curTarget getVariable ["restrained", false])) then {
			_Btn1 ctrlSetText "Zakuj";
			_Btn1 buttonSetAction "[] call life_fnc_restrainAction; closeDialog 0;";
