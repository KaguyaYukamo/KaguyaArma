...
switch (true) do {
	...
	case (_item isEqualTo "silnik"): {
          [cursorTarget] spawn life_fnc_silnik;
      };
	case (_item isEqualTo "Wheel"): {
          [cursorTarget] spawn life_fnc_Wheel;
      };
	case (_item isEqualTo "hull"): {
          [cursorTarget] spawn life_fnc_hull;
      };
	case (_item isEqualTo "fuel"): {
          [cursorTarget] spawn life_fnc_fuel;
      };
